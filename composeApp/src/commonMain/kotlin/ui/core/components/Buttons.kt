...
import ui.core.theme.BorderColor
import ui.core.theme.DefaultButtonTheme
import ui.core.theme.DefaultButtonWithBorderPrimaryTheme
...
fun ButtonLoading(
    ...
    Button(
        ...
        Row(
            ...
            AnimatedVisibility(visible = (progressBarState == ProgressBarState.ProgressAlertLoading || progressBarState == ProgressBarState.FullScreenLoading)) {
